...
public class DeviceTemplatePriceService {
    ...
    private static List<SearchResultFieldDesc> FIELDS_DESC = Arrays.asList(
            ...
            new SearchResultFieldDesc(false, "8%", new ClientMessage("Desc", "描述"),
                    TableDisplay.MANDATORY, Type.TEXT, false, false),
            new SearchResultFieldDesc(false, "8%", new ClientMessage("Total(Y)", "单价(元)"),
                    TableDisplay.MANDATORY, Type.TEXT, false, false),
            new SearchResultFieldDesc(false, "8%", new ClientMessage("CPU Total", "CPU数量"),
                    TableDisplay.MANDATORY, Type.TEXT, false, false),
            new SearchResultFieldDesc(false, "8%", new ClientMessage("CPU Price(Y)", "CPU单价(元)"),
                    TableDisplay.MANDATORY, Type.TEXT, false, false),
            new SearchResultFieldDesc(false, "8%", new ClientMessage("Memory Total(MB)", "内存数量(MB)"),
                    TableDisplay.MANDATORY, Type.TEXT, false, false),
            new SearchResultFieldDesc(false, "8%", new ClientMessage("Memory(Y/MB)", "内存单价(元/MB)"),
                    TableDisplay.MANDATORY, Type.TEXT, false, false),
            new SearchResultFieldDesc(false, "8%", new ClientMessage("Disk Total(MB)", "硬盘数量(MB)"),
                    TableDisplay.MANDATORY, Type.TEXT, false, false),
            new SearchResultFieldDesc(false, "8%", new ClientMessage("Disk(Y/MB)", "硬盘单价(元/MB)"),
                    TableDisplay.MANDATORY, Type.TEXT, false, false),
            new SearchResultFieldDesc(false, "8%", new ClientMessage("BW Total(KB)", "带宽数量(KB)"),
                    TableDisplay.MANDATORY, Type.TEXT, false, false),
            new SearchResultFieldDesc(false, "8%", new ClientMessage("BW(Y/KB)", "带宽单价(元/KB)"),
                    TableDisplay.MANDATORY, Type.TEXT, false, false),
    ...
    public static SearchResult lookupTemplatePriceByDate(Session session, SearchRange range, Date dateBegin, Date dateEnd) throws EucalyptusServiceException {
    ...
    public static void createTemplatePriceByID(Session session, int template_id, String tp_desc, double tp_cpu, double tp_mem, double tp_disk, double tp_bw) throws EucalyptusServiceException {
    ...
    public static void deleteTemplatePrice(Session session, List<Integer> tp_ids) throws EucalyptusServiceException {
        if (!getUser(session).isSystemAdmin()) {
            throw new EucalyptusServiceException(new ClientMessage("", "权限不足 操作无效"));
        }
    ...
    public static void modifyTemplatePrice(Session session, int tp_id, String tp_desc, double tp_cpu, double tp_mem, double tp_disk, double tp_bw) throws EucalyptusServiceException {
        if (!getUser(session).isSystemAdmin()) {
    ...
    public static TemplatePriceInfo lookupTemplatePriceByID(int tp_id) throws EucalyptusServiceException {
        Connection conn = null;
        try {
            conn = DBProcWrapper.getConnection();
            DBTableTemplatePrice TEMPLATE_PRICE = DBTable.TEMPLATE_PRICE;
    ...
    public static Map<String, Integer> lookupTemplatesWithoutPrice(Session session) throws EucalyptusServiceException {
        if (!getUser(session).isSystemAdmin()) {
            throw new EucalyptusServiceException(ClientMessage.PERMISSION_DENIED);
        }
        Connection conn = null;
    ...
    static class DeviceTemplatePriceDBProcWrapper {
