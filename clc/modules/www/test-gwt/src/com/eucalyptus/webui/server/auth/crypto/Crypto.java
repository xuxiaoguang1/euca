...
/**
 * Facade for helpers and a set of generator methods providing non-trivial
 * random tokens.
 * 
 * @author decker
 */
...
public class Crypto {
	 ...
	 * @param password
	 * @return
	 * @see com.eucalyptus.webui.server.auth.crypto.CryptoProvider#generateHashedPassword(java.lang.String)
	 */
	...
	/**
	 * @see com.eucalyptus.webui.server.auth.crypto.CryptoProvider#generateSessionToken()
	 */
	...
	/**
	 * @see com.eucalyptus.webui.server.auth.crypto.CryptoProvider#generateQueryId()
	 */
	...
	/**
	 * @see com.eucalyptus.webui.server.auth.crypto.CryptoProvider#generateSecretKey()
	 */
	...
	/**
	 * @see com.eucalyptus.webui.server.auth.crypto.CryptoProvider#getDigestBase64(java.lang.String,
	 *      com.eucalyptus.webui.server.auth.crypto.Digest)
	 */
	...
	public static boolean verifyLinuxSaltedPassword(final String clear,
			final String hashed) {
		return Crypto.getCryptoProvider().verifyLinuxSaltedPassword(clear,
				hashed);
	}

	/**
	 * verifyPassword checks if a hashed password matches its clear text form,
	 * using Linux-compatible salted password hash; if not match, fall back to
	 * original non-salted hash.
	 * 
	 * @param clear
	 * @param hashed
	 * @return
