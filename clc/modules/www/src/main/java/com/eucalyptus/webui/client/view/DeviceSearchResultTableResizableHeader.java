...
//
//public class DeviceSearchResultTableResizableHeader<T> extends Header<String> {
//    
...
//    
//    public DeviceSearchResultTableResizableHeader(int minWidth, String title, AbstractCellTable<T> cellTable, Column<T, ?> column) {
...
//                int absoluteLeft = ele.getAbsoluteLeft();
//                int offsetWidth = ele.getOffsetWidth();
//                if (clientX > absoluteLeft + offsetWidth - minWidth / 4) {
...
//                }
//                if (title != null) {
//                    max = Math.max(measureText(title), max);
//                }
//                finishMeasuring();
//                table.setColumnWidth(col, max + "px");
//                removeHandler();
//            }
//        }
//        
