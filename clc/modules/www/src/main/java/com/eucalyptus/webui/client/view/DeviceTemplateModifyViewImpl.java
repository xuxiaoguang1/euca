...
public class DeviceTemplateModifyViewImpl extends DialogBox implements DeviceTemplateModifyView {
	...
	public void popup(SearchResultRow row) {
		...
		setSelected(selected.getField(DeviceTemplateServiceProcImpl.TABLE_COL_INDEX_CPU));
		...
		cpuNumList.setSelectedIndex(intValue(selected.getField(DeviceTemplateServiceProcImpl.TABLE_COL_INDEX_NCPUS)));
