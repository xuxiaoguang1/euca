...
public class HistoryViewImpl extends Composite implements HistoryView {
	...
	private static final Logger LOG = Logger.getLogger(HistoryViewImpl.class
			.getName());
	...
	private void initializeTable(int pageSize,
			ArrayList<SearchResultFieldDesc> fieldDescs) {
		tablePanel.clear();
		selectionModel = new MultiSelectionModel<SearchResultRow>(
		...
		table = new SearchResultTable(pageSize, fieldDescs, this.presenter,
				selectionModel);
