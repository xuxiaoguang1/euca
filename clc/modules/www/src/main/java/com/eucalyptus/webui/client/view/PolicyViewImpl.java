...
public class PolicyViewImpl extends Composite implements PolicyView {
  
  private static final Logger LOG = Logger.getLogger( PolicyViewImpl.class.getName( ) );
  ...
  void handleModigyButtonClick( ClickEvent e ) {
    this.presenter.onModifyPolicy();
  }
