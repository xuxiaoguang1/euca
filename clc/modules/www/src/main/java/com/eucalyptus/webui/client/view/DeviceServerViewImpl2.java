...
public class DeviceServerViewImpl2 extends Composite implements DeviceServerView2 {

	private static CPUViewImplUiBinder uiBinder = GWT.create(CPUViewImplUiBinder.class);

	interface CPUViewImplUiBinder extends UiBinder<Widget, DeviceServerViewImpl2> {
	}
