...
public class ServerInfo implements Serializable {
    ...
    public ServerInfo(int server_id, String server_name, String server_desc, String server_euca, String server_ip, int server_bw, ServerState server_state, Date server_creationtime, Date server_modifiedtime, int cabinet_id) {
        this.server_id = server_id;
        this.server_name = server_name;
        this.server_desc = server_desc;
        this.server_euca = server_euca;
