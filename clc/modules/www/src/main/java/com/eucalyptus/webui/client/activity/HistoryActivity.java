...
public class HistoryActivity extends AbstractSearchActivity implements
		HistoryView.Presenter {

	public static final String TITLE[] = { "History", "历史记录" };
...
//			"Policy content", "策略内容" };
	...
	private static final Logger LOG = Logger.getLogger(HistoryActivity.class.getName());
...
//		groupDetailActivity = new GroupDetailActivity(place, clientFactory);
	...
	protected void doSearch(String query, SearchRange range) {
		this.clientFactory.getBackendService().lookupHistory(
...
//					public void onSuccess(SearchResult result) {
//						// TODO Auto-generated method stub
//						clientFactory.getGroupDetailView().showSearchResult(
//								result);
//					}
//				});
//	}
