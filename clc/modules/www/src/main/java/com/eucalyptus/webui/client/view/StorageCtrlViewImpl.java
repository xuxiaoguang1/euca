...
public class StorageCtrlViewImpl extends Composite implements StorageCtrlView {
  
  private static final Logger LOG = Logger.getLogger( StorageCtrlViewImpl.class.getName( ) );
  
  private static StorageCtrlViewImplUiBinder uiBinder = GWT.create( StorageCtrlViewImplUiBinder.class );
  
  interface StorageCtrlViewImplUiBinder extends UiBinder<Widget, StorageCtrlViewImpl> {}
