...
public class ClusterCtrlViewImpl extends Composite implements ClusterCtrlView {
  
  private static final Logger LOG = Logger.getLogger( ClusterCtrlViewImpl.class.getName( ) );
  
  private static ClusterCtrlViewImplUiBinder uiBinder = GWT.create( ClusterCtrlViewImplUiBinder.class );
  
  interface ClusterCtrlViewImplUiBinder extends UiBinder<Widget, ClusterCtrlViewImpl> {}
