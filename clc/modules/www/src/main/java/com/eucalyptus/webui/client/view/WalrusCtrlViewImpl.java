...
public class WalrusCtrlViewImpl extends Composite implements WalrusCtrlView {
  
  private static final Logger LOG = Logger.getLogger( WalrusCtrlViewImpl.class.getName( ) );
  
  private static WalrusCtrlViewImplUiBinder uiBinder = GWT.create( WalrusCtrlViewImplUiBinder.class );
  
  interface WalrusCtrlViewImplUiBinder extends UiBinder<Widget, WalrusCtrlViewImpl> {}
