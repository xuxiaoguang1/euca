...
public interface DeviceServerAddView extends IsWidget {
    ...
    public interface Presenter {
        ...
        public boolean onOK(String server_name, String server_desc, String server_euca, String server_ip, String server_bw, ServerState server_state, int cabinet_id);
