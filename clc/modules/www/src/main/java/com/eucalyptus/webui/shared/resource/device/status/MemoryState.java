...
public class MemoryState implements Serializable {
    ...
    public static final MemoryState INUSE = new MemoryState(0, new ClientMessage("NORMAL", "使用"));
    public static final MemoryState STOP = new MemoryState(1, new ClientMessage("STOP", "停止"));
    public static final MemoryState RESERVED = new MemoryState(2, new ClientMessage("RESERVED", "预留"));
    
    private MemoryState() {
    }
    
    private MemoryState(int value, ClientMessage message) {
        this.value = value;
